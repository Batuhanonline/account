...
public class GeneralExeptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> customerNotFoundExeptionHandler(CustomerNotFoundExeption exeption) {
